...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "rgl", "~> 0.5", ">= 0.5"
  spec.add_runtime_dependency "rinruby", "~> 2.0", ">= 2.0"
  spec.add_runtime_dependency "json", "~> 2.1", ">= 2.1"
  spec.add_runtime_dependency "mqtt", "~> 0.5", ">= 0.5"
  ...
  spec.add_development_dependency "bundler", "~> 1.15", ">= 1.15"
